...
Navigates To My Account Page
    ...
    Click Element [Arguments] ${userProfileNameLabel} ${SMALL_RETRY_COUNT}
...
User Is In The My Account Page
    ...
    Element Text Should Be [Arguments] ${myAccountPageTitleLabel} ${MY_ACCOUNT_PAGE_TITLE} ${SMALL_RETRY_COUNT}
...
Search An Item [Arguments] ${searchText}
    ...
    Set Text [Arguments] ${searchTextBox} ${searchText} ${SMALL_RETRY_COUNT}
    Click Element [Arguments] ${searchButton} ${SMALL_RETRY_COUNT}
...
Verify That The Item Is Visible [Arguments] ${itemNameVal}
    ...
    Element Text Should Be [Arguments] ${firstSearchResultLabel} ${itemNameVal} ${SMALL_RETRY_COUNT}